...
public static class Endpoints
{
    public static void MapFinanceiroEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        g.MapGet("/metodos", async (FinanceiroDbContext db) => Results.Ok(await db.MetodosPagamento.AsNoTracking().ToListAsync())).WithSummary("Lista métodos de pagamento");
        g.MapPost("/metodos", async (MetodoPagamentoDto dto, FinanceiroDbContext db) => {
        ...
        g.MapPut("/metodos/{id:long}", async (long id, MetodoPagamentoDto dto, FinanceiroDbContext db) => {
        ...
        g.MapDelete("/metodos/{id:long}", async (long id, FinanceiroDbContext db) => {
        ...
        g.MapGet("/contas-pagar", async (FinanceiroDbContext db) => Results.Ok(await db.ContasPagar.AsNoTracking().ToListAsync())).WithSummary("Lista contas a pagar");
        g.MapPost("/contas-pagar", async (ContaPagarDto dto, FinanceiroDbContext db) => {
        ...
        g.MapPut("/contas-pagar/{id:long}", async (long id, ContaPagarDto dto, FinanceiroDbContext db) => {
        ...
        g.MapDelete("/contas-pagar/{id:long}", async (long id, FinanceiroDbContext db) => {
        ...
        g.MapGet("/contas-receber", async (FinanceiroDbContext db) => Results.Ok(await db.ContasReceber.AsNoTracking().ToListAsync())).WithSummary("Lista contas a receber");
        g.MapPost("/contas-receber", async (ContaReceberDto dto, FinanceiroDbContext db) => {
        ...
        g.MapPut("/contas-receber/{id:long}", async (long id, ContaReceberDto dto, FinanceiroDbContext db) => {
        ...
        g.MapDelete("/contas-receber/{id:long}", async (long id, FinanceiroDbContext db) => {
        ...
        g.MapGet("/lancamentos", async (FinanceiroDbContext db) => Results.Ok(await db.Lancamentos.AsNoTracking().ToListAsync())).WithSummary("Lista lançamentos");
        g.MapPost("/lancamentos", async (LancamentoDto dto, FinanceiroDbContext db) => {
        ...
        g.MapPut("/lancamentos/{id:long}", async (long id, LancamentoDto dto, FinanceiroDbContext db) => {
        ...
        g.MapDelete("/lancamentos/{id:long}", async (long id, FinanceiroDbContext db) => {
        ...
        g.MapGet("/anexos", async (FinanceiroDbContext db) => Results.Ok(await db.Anexos.AsNoTracking().ToListAsync())).WithSummary("Lista anexos financeiros");
        g.MapPost("/anexos", async (FinanceiroAnexoDto dto, FinanceiroDbContext db) => {
        ...
        g.MapDelete("/anexos/{id:long}", async (long id, FinanceiroDbContext db) => {
        ...
        g.MapGet("/historico", async (FinanceiroDbContext db) => Results.Ok(await db.Historicos.AsNoTracking().ToListAsync())).WithSummary("Lista histórico financeiro");
        g.MapPost("/historico", async (FinanceiroHistoricoDto dto, FinanceiroDbContext db) => {
        ...
        g.MapDelete("/historico/{id:long}", async (long id, FinanceiroDbContext db) => {
